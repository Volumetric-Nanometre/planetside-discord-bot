...
class Messages:
	...
	gateChannelDefaultMsg = "Welcome!\nThis is an isolated test server for TDKD.\n\nIf you've unintentionally ended up here instead of the actual TDKD discord, use this invitation: https://discord.gg/TeFG29e\n\nTo get started, use the button below."
